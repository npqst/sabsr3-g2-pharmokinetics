...
class Solution(AbstractSolution):
    ...
    def __init__(self, solution_vector) -> None:
        """Initialise instance of Solution class with a solution vector generated by Model. 

        :param solution_vector: x * t matrix where x is number of compartments and t is length of time vector
    ...
    def get_solution(self):
        ...
        :return: x * t matrix where x is number of compartments and t is length of time vector
